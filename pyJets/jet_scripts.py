...
def plot_new_sj():
    ...
    pt.plot.plot_colormap(filename="/wrk/group/spacephysics/vlasiator/2D/ABC/bulk/bulk.0000677.vlsv",usesci=0,lin=1,boxre=[6,18,-8,6],var="B",operator="z",vmin=-5e-9,vmax=5e-9,colormap="parula",external=nsj_ext,pass_vars=["Mmsx","rho","B","RhoNonBackstream","PTensorNonBackstreamDiagonal"])
